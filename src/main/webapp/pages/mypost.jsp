...
<%--                %>--%>
                ...
                <div class="list-group-item">
                    <a href="<%=path%>/pages/post.jsp?postId=%>&&page=1" style="color:grey">
                        <h4 class="list-group-item-heading" style="color:black"></h4>
<%--                        <%=post.getTitle() %>--%>
                    </a>
                    <a href="<%=path%>/editpost.action?postId=%>" style="float: right">编辑</a>
<%--                    <%if (post.getPostType() == 0 && !bestPostBiz.isExist(post.getId())) {%>--%>
                    <a href="<%=path%>/applybest.action?postId=" style="float: right">申请精华贴&nbsp;</a>
<%--                    <%} %>--%>
                    <p style="float: right;margin-right: 50px">浏览量:&nbsp;评论量:&nbsp;%></p>
                </div>
<%-- 				<%} %>--%>
            </ul>
